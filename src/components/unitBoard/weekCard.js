...
//this.context.history.push('/home/sidebar/kfc3241')
    ...
    render() { 
         return (
             <Link to={'/home/sidebar/'+this.props.unitName+'/'+this.props.branchId} style={{textDecoration:'none'}}>
             <div style={{width: "100%"}} className="border-2 rounded border-light-grey p-4 my-2">
                 <div>
                    <div className="brow bg-red-light mb-1"></div>
                    <div className="text-grey-darkest font-medium text-lg">{this.props.weekName}</div>
                 </div>
