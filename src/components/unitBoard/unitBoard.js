...
class UnitBoard extends Component {
    ...
    render() { 
        ...
        return ( <div style={{minWidth:"250px", height:'calc(100% - 32px)' , overflow:'hidden', borderRadius:'1rem', borderColor:borderColor}} 
        ...
        <div className="px-4 pt-0 py-4" style={ {overflowY: 'scroll', height: 'calc(100% - 66px)'}}>
